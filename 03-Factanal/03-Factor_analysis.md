...
> 
> # Perform PCA
> pca_result <- prcomp(t(dat_onlyItems), scale. = FALSE)
> results_pca <- data.frame(pca_result$rotation)
> results_pca$ParticipantId <- rownames(results_pca)
> usable_data$ParticipantId <- rownames(usable_data)
> pca_result <- results_pca %>% left_join(usable_data[,c("ParticipantId","Context")])
```

    ## Joining with `by = join_by(ParticipantId)`

``` r
> # Visualize the PCA result
> sd_pc2 <- sd(pca_result$PC2)
> mean_pc2 <- mean(pca_result$PC2)
> 
> sd_pc1 <- sd(pca_result$PC1)
> mean_pc1 <- mean(pca_result$PC1)
> 
> ggplot(pca_result, aes(x = PC1, y = PC2, colour = Context)) + geom_point() 
```
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-12-4.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-12-5.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-12-6.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-12-7.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-14-2.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-14-3.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-34-4.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-34-5.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-34-6.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-36-3.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-36-4.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-36-5.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-36-6.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-40-1.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-40-2.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-40-3.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-40-4.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-40-5.png)<!-- -->
...
![](03-Factor_analysis_files/figure-gfm/unnamed-chunk-40-6.png)<!-- -->
