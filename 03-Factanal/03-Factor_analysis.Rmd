...
sum_stat %>%
  ...
  geom_errorbar(aes(ymin=LowerBoundCI, ymax=UpperBoundCI),width=0.2) + geom_point() +theme(axis.text.x = element_text(angle = 45, hjust = 1))+ ggtitle("Mean +- 95% CI") +
    ...
    labs(y="Mean factor with 95%CIå")

ggsave(file.path("03-Factanal/03-Factor_analysis_figures",paste0("final-FA-",fac,".png")),width = 7,height = 5)
