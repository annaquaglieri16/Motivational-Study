...
```{r echo = TRUE}
english_in_germany <- read_excel("~/Desktop/Richi_analysis/english_in_germany.xlsx", skip = 1)
...
english_in_italy <- read_excel("~/Desktop/Richi_analysis/english_in_italy.xlsx", skip = 1)
colnames(english_in_italy) <- gsub("\n","",colnames(english_in_italy))
colnames(english_in_italy) <- gsub("\r\n","",colnames(english_in_italy))
colnames(english_in_italy) <- gsub("\r","",colnames(english_in_italy))

german_in_australia <- read_excel("~/Desktop/Richi_analysis/german_in_australia.xlsx", skip = 1)
...
italian_in_australia <- read_excel("~/Desktop/Richi_analysis/italian_in_australia.xlsx")
...
write.csv(english_in_italy,"english_in_italy_cleaned.csv",row.names = FALSE)
write.csv(english_in_germany,"english_in_germany_cleaned.csv",row.names = FALSE)
```
...
write.csv(italian_in_australia,"italian_in_australia_cleaned.csv",row.names = FALSE)
```
...
write.csv(german_in_australia,"german_in_australia_cleaned.csv",row.names = FALSE)
```

# Read cleaned datasets

```{r message=FALSE}
english_in_germany <- read_csv("~/Desktop/Richi_analysis/english_in_germany_cleaned.csv")
english_in_italy <- read_csv("~/Desktop/Richi_analysis/english_in_italy_cleaned.csv")

italian_in_australia <- read_csv("~/Desktop/Richi_analysis/italian_in_australia_cleaned.csv")
german_in_australia <- read_csv("~/Desktop/Richi_analysis/german_in_australia_cleaned.csv")
```
...
```{r}
english_in_germany_cleaned_csv <- read_excel("~/Desktop/Richi_analysis/columns_recoded_demographics/english_in_germany_cleaned.csv.xlsx")
colnames(english_in_germany_cleaned_csv)[!(colnames(english_in_germany_cleaned_csv) %in% colnames(english_in_germany))]
english_in_germany_cleaned_red <- subset(english_in_germany_cleaned_csv,select=c("Resp.ID","other.attrib.richi","other.external.richi","other.sector.richi","other.year.studyL2.richi","other.other.ways.richi","other.degree.richi"))
...
write_csv(english_in_germany,"~/Desktop/Richi_analysis/english_in_germany_cleaned_recoded.csv")
```

1. English in Italy

```{r}
english_in_italy_cleaned_csv <-  read_excel("~/Desktop/Richi_analysis/columns_recoded_demographics/english_in_italy_cleaned.csv.xlsx")
...
write_csv(english_in_italy,"~/Desktop/Richi_analysis/english_in_italy_cleaned_recoded.csv")
```

- German in Australia

```{r}
german_in_australia_cleaned_csv <- read_excel("~/Desktop/Richi_analysis/columns_recoded_demographics/german_in_australia_cleaned.csv.xlsx")
...
# in English in Italy the degree is always only one 
write_csv(german_in_australia,"~/Desktop/Richi_analysis/german_in_australia_cleaned_recoded.csv")
```

- Italian in Australia

```{r}
italian_in_australia_cleaned_csv <- read_excel("~/Desktop/Richi_analysis/columns_recoded_demographics/italian_in_australia_cleaned.csv.xlsx")
...
write_csv(italian_in_australia,"~/Desktop/Richi_analysis/italian_in_australia_cleaned_recoded.csv")
```
...
```{r}
italian_in_australia <- read_csv("~/Desktop/Richi_analysis/italian_in_australia_cleaned_recoded.csv")
german_in_australia <- read_csv("~/Desktop/Richi_analysis/german_in_australia_cleaned_recoded.csv")
english_in_germany <- read_csv("~/Desktop/Richi_analysis/english_in_germany_cleaned_recoded.csv")
english_in_italy <- read_csv("~/Desktop/Richi_analysis/english_in_italy_cleaned_recoded.csv")

english_in_italy1 <- read_csv("~/Desktop/Richi_analysis/english_in_italy_cleaned.csv")
```
...
write.csv(australian,"australian_recoded.csv",row.names = FALSE)
```
...
write.csv(european,"european_recoded.csv",row.names = FALSE)
```
