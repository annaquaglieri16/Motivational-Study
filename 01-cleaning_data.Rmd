...
english_in_germany$noextern6.external <- ifelse(!is.na(english_in_germany$other7.external) &  english_in_germany$other7.external %in% "M.NO.EXTERNAL.FACTORS",1,english_in_germany$noextern6.external)
...
english_in_italy1 <- english_in_italy

english_in_italy <- merge(english_in_italy,english_in_italy_cleaned_csv,all = TRUE)
...
english_in_italy$noextern6.external <- ifelse(!is.na(english_in_italy$other7.external) & english_in_italy$other7.external == "M.NO.EXTERNAL.FACTORS",1,english_in_italy$noextern6.external)

#english_in_italy[english_in_italy$other7.external == "M.NO.EXTERNAL.FACTORS","Resp.ID"]
...
german_in_australia$noextern6.external <- ifelse(!is.na(german_in_australia$other7.external) & german_in_australia$other7.external == "M.NO.EXTERNAL.FACTORS",1,german_in_australia$noextern6.external )
...
german_in_australia$intrelations9.sector <- ifelse(!is.na(german_in_australia$other11.sector) & german_in_australia$other11.sector == "M.INTERNATIONAL.RELATIONS",1,german_in_australia$intrelations9.sector)
...
italian_in_australia$noextern6.external <- ifelse(!is.na(italian_in_australia$other7.external) & italian_in_australia$other7.external %in% "M.NO.EXTERNAL.FACTORS",1,italian_in_australia$noextern6.external)

italian_in_australia$parents1.external <- ifelse(!is.na(italian_in_australia$other7.external) &  italian_in_australia$other7.external %in% "M.INFLUENCE.FROM.PARENTS",1,italian_in_australia$parents1.external)
...
italian_in_australia$intrelations9.sector <- ifelse(!is.na(italian_in_australia$other11.sector) & italian_in_australia$other11.sector %in% "M.INTERNATIONAL.RELATIONS",1,italian_in_australia$intrelations9.sector)
